...
class InteractionTerm(hk.Module):
    ...
    def hamiltonian(
        ...
        described by the InteractingSystems object

        Args:
            subsystem_list:
                list of all quantum systems in InteractingSystems calling ``hamiltonian``,
...
class InteractingSystems(QuantumSystem):
    ...
    def __getitem__(self, key: Union[int, str]):
        ...
        raise KeyError(
            ...
            "string specifying a subsystem of InteractingSystems.")
    ...
    def coupling_hamiltonian(self) -> jnp.ndarray:
        ...
        specified for the current InteractingSystems object.
    ...
    def dim(self):
        ...
        return tuple([qdevice.dim for qdevice in self])
