    ...
    def __init__(self, seed=None):
        ...
        self.add_node(
            'q22', **{
                ...
                'compensation': {
                    'pre_comp':
                        jnp.array([-6.06081433e-04, -1.64773922e+00, -2.04536211e+00]),
                    'post_comp':
...
class PeriodicGraphOpt(PeriodicGraph):
    ...
    def __init__(self, seed=None):
        ...
        device_params = jax.tree_map(lambda g, v: v - 0.01 * g, device_grad,
                                     device_params)
  ...
  "properties": {
    ...
    "variance": {
      ...
      "description": "The variance of ec, ej, el parameters.
                        The values here are multiplied to the ec ej el if enable_var = True in Evolve
                        see hamiltonian/common_functions/compute_unitary_evolve.py",
      "properties": {
        "ec": {
          "type": "array",
