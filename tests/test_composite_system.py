...
import supergrad
from supergrad.quantum_system import Fluxonium, Transmon, InteractingSystems, Resonator, parse_interaction
    ...
    class ExploreTransmon(supergrad.Helper):
        ...
        def _init_quantum_system(self):
            ...
            coup2 = parse_interaction(g_strength=0.2,
                                      ...
                                      add_hc=True,
                                      constant=True)
            self.hilbertspace = InteractingSystems([tm1, tm2, res],
                                                   [coup1, coup2])
    ...
    class ExploreTransmon(supergrad.Helper):
        ...
        def _init_quantum_system(self):
            ...
            coup4 = parse_interaction(g_strength=-0.02,
                                      ...
                                      op2=coupler1.phi_operator,
                                      constant=True)
            self.hilbertspace = InteractingSystems([fm1, coupler1, fm2],
